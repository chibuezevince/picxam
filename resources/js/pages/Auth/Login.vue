...
import { login } from "../../composables/useAuth.ts"
...
watch([() => form.email, () => form.password], markModified)
...
const handleSubmit = async () => {
  ...
  if (status === 401) {
    setFlash("message", "Please, verify your email address.")
  ...
  <section class="grid grid-cols-1 md:grid-cols-12 min-h-[70vh]">
    ...
    >
      <div class="space-y-4">
        ...
        >
          Welcome Back!<br />Sign in to Continue<br />Generating.
        </h1>
        <p
          class="text-sm md:text-base font-light opacity-70 max-w-md leading-relaxed"
        >
          Log in to your account and start generating questions from your
    ...
    <div class="md:col-span-6 flex flex-col justify-center">
      <div class="w-full max-w-md mx-auto space-y-6">
        <br />
        <h2 class="text-xl font-medium inline">Login</h2>
