...
<template>
  ...
  <div class="flex-1 flex flex-col overflow-y-auto">
    ...
    >
      <div
        class="md:col-span-3 flex flex-col justify-between p-8 md:p-12 lg:p-16 min-h-80 md:min-h-0 relative"
        @dragover="onDragOver"
        ...
        <div class="w-full mt-3">
          <div class="border-2 border-[#3aff8c]/20 bg-[#3aff8c]/5 p-4">
            ...
            <p class="text-xs text-gray-400 mt-1.5 leading-relaxed">
              Each extracted image from your document will generate 2 questions
              automatically.
            </p>
          </div>

          <div class="mt-4 border-2 border-amber-500/20 bg-amber-500/3 p-4">
      ...
      <div
        class="md:col-span-2 flex flex-col justify-between p-8 md:p-10 lg:p-12"
      >
        <div>
          <div class="mb-10">
            <span
          ...
          <div class="mb-8">
            <span
              class="text-[10px] text-gray-500 uppercase tracking-[0.15em] font-medium block mb-4"
              >Thinking Effort</span
            >
            <div class="grid grid-cols-2 gap-0 border-2 border-[#2a2a30]">
              <button
                type="button"
                class="px-3 py-3 text-[11px] uppercase tracking-wider font-medium transition-all duration-200 cursor-pointer"
                :class="
                  form.thinking_effort === 'non-thinking'
                    ? 'bg-[#3aff8c]/10 border-[#3aff8c] text-[#3aff8c]'
                    : 'text-gray-500 hover:text-gray-300'
                "
                style="border-width: 0 1px 0 0; border-color: #2a2a30"
                @click="form.thinking_effort = 'non-thinking'"
              >
                Non-Thinking
              </button>
              <button
                ...
                class="px-3 py-3 text-[11px] uppercase tracking-wider font-medium transition-all duration-200 cursor-pointer"
                :class="
                  form.thinking_effort === 'thinking'
                    ? 'bg-[#3aff8c]/10 border-[#3aff8c] text-[#3aff8c]'
                    : 'text-gray-500 hover:text-gray-300'
                "
                @click="form.thinking_effort = 'thinking'"
              >
                Thinking
              </button>
            </div>
            <FormBadge
              :show="!!form.errors.thinking_effort"
              type="error"
              class="mt-3"
            >
              {{ form.errors.thinking_effort }}
            </FormBadge>
            <p
              v-if="form.thinking_effort === 'thinking'"
              class="mt-2 text-[10px] text-amber-400/70 leading-relaxed"
            >
              Thinking mode may take significantly more time to generate.
            </p>
          </div>
